...
export default function EstadisticasPage() {
    ...
    useEffect(() => {
        ...
        async function fetchStats() {
            try {
                // Fetch all chats
                const convsSnapshot = await getDocs(collection(db, 'clients', tenantId, 'conversaciones'));
                ...
                const reservasSnapshot = await getDocs(collection(db, 'clients', tenantId, 'reservas'));
