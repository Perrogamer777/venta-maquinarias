...
export default function FeedbackPage() {
    ...
    useEffect(() => {
        ...
        // Real-time listener
        const q = query(collection(db, 'clients', tenantId, 'feedback'), orderBy('createdAt', 'desc'));
    ...
    useEffect(() => {
        ...
        const commentsRef = collection(db, 'clients', tenantId!, 'feedback', selectedPost.id, 'comments');
    ...
    const handleVote = async (post: FeedbackPost, e: React.MouseEvent) => {
        ...
        const postRef = doc(db, 'clients', tenantId!, 'feedback', post.id);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await addDoc(collection(db, 'clients', tenantId!, 'feedback'), {
                ...formData,
                votes: 0,
                votedBy: [],
                status: 'pendiente',
