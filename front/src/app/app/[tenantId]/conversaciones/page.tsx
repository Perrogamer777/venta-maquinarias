...
export default function ConversacionesPage() {
    ...
    useEffect(() => {
        ...
        // ✅ REAL-TIME LISTENER FROM TENANT COLLECTION
        const unsubscribe = onSnapshot(
            collection(db, 'clients', tenantId, 'conversaciones'),
            async (snapshot) => {
                ...
                for (const docSnapshot of snapshot.docs) {
                    ...
                    // TODO: Migrate to 'clients/{tenantId}/conversaciones/{telefono}/messages' when backend is ready
